...
/**
 * Created by MinKook on 2017-10-18.
 */

public class Schedule {
    /*총 오전, 오후 14교시*/
    public static final int classTimeSize = 14;

    private String monday[] = new String[classTimeSize];
    private String tuesday[] = new String[classTimeSize];
    private String wednesday[] = new String[classTimeSize];
    private String thursday[] = new String[classTimeSize];
    private String friday[] = new String[classTimeSize];

    public Schedule(){
        for (int i=0; i < classTimeSize; i++){
            monday[i] = "";
            tuesday[i] = "";
            wednesday[i] = "";
            thursday[i] = "";
